...
public class UMCarroJa_ESTest extends UMCarroJa_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      UMCarroJa uMCarroJa0 = new UMCarroJa();
      Double double0 = new Double((-2053.1135193117675));
      CarModel.CarType carModel_CarType0 = CarModel.CarType.ANY;
      Owner owner0 = new Owner("main.java.model.UMCarroJa", "", "", 0, "");
      CarModel carModel0 = new CarModel(carModel_CarType0, 0, "");
      Point point0 = new Point(double0, double0);
      Car car0 = new Car("", owner0, carModel0, (-2053.1135193117675), 0.0, (-1288), point0);
      Client client0 = new Client(point0, "Tempo Estimado: ", "", "SlyV~ Qi", "", (-1288));
      Rental rental0 = new Rental(car0, client0, point0);
      uMCarroJa0.rate(owner0, rental0, (-151));
      assertEquals((-151), client0.getRates());
  }
  ...
  public void test06()  throws Throwable  {
      UMCarroJa uMCarroJa0 = new UMCarroJa();
      Owner owner0 = new Owner("", "", "", 1860, "main.java.model.UMCarroJa");
      // Undeclared exception!
      try { 
        uMCarroJa0.swapState(owner0, 3091);
  ...
  public void test12()  throws Throwable  {
      UMCarroJa uMCarroJa0 = new UMCarroJa();
      Double double0 = new Double(614.5377301821);
      Point point0 = new Point(double0, double0);
      try { 
        uMCarroJa0.rental(point0, "%.2f Horas", (Client) null);
  ...
  public void test14()  throws Throwable  {
      UMCarroJa uMCarroJa0 = new UMCarroJa();
      Double double0 = new Double((-665.0));
      Point point0 = new Point(double0, double0);
      Client client0 = new Client(point0, "main.java.model.UMCarroJa", "A>#b?0W1RBc", "main.java.model.UMCarroJa", "A>#b?0W1RBc", 0);
      CarModel.CarType carModel_CarType0 = CarModel.CarType.ELECTRIC;
      try { 
        uMCarroJa0.rental(client0, point0, 0.0, carModel_CarType0);
        fail("Expecting exception: Exception");
  ...
  public void test28()  throws Throwable  {
      UMCarroJa uMCarroJa0 = new UMCarroJa();
      Owner owner0 = new Owner("~q!%Q", "~q!%Q", "Can't write to file!!\n", 6, "Can't write to file!!\n");
  ...
  public void test31()  throws Throwable  {
      UMCarroJa uMCarroJa0 = new UMCarroJa();
      Owner owner0 = new Owner("", (String) null, (String) null, (-2113), (String) null);
      CarModel.CarType carModel_CarType0 = CarModel.CarType.GAS;
      CarModel carModel0 = new CarModel(carModel_CarType0, (-2113), "");
      Double double0 = Double.valueOf(0.4);
      Point point0 = new Point(double0, double0);
      try { 
        uMCarroJa0.addCar(owner0, carModel0, (String) null, (-2113), 0.4, (-2113), point0);
        fail("Expecting exception: Exception");
  ...
  public void test33()  throws Throwable  {
      UMCarroJa uMCarroJa0 = new UMCarroJa();
      Owner owner0 = new Owner("b-U`5", "(-208.76, -208.76)", "djp:s 0M|)3g", 3, "Tempo Estimado: ");
  ...
  public void test34()  throws Throwable  {
      ...
      Double double0 = new Double(0.0);
      Point point0 = new Point(double0, double0);
      Client client0 = new Client(point0, (String) null, "\u001B[30m", "\u001B[30m", (String) null, 0);
      CarModel.CarType carModel_CarType0 = CarModel.CarType.ANY;
      try { 
        uMCarroJa0.rental(client0, point0, "\u001B[30m", carModel_CarType0);
        fail("Expecting exception: Exception");
  ...
  public void test35()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        uMCarroJa0.swapState(owner0, (-536));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test36()  throws Throwable  {
      ...
      Point point0 = new Point(double0, double0);
      CarModel.CarType carModel_CarType0 = CarModel.CarType.HYBRID;
      CarModel carModel0 = new CarModel(carModel_CarType0, 3, "main.java.model.Weather");
      try { 
        uMCarroJa0.addCar((String) null, "djp:s 0M|)3g", carModel0, (-208.75778472791), (-208.75778472791), (-1500), point0);
        fail("Expecting exception: Exception");
  ...
  public void test41()  throws Throwable  {
      ...
      Double double0 = new Double((-1.0));
      Point point0 = new Point(double0, double0);
      Client client0 = new Client(point0, ":IBh|*zESs`y)om^3", "", "Can't write to file!!\n", (String) null, 0);
  ...
  public void test42()  throws Throwable  {
      UMCarroJa uMCarroJa0 = new UMCarroJa();
      Owner owner0 = new Owner("SM`]W(ioa$!|#>fUqc", "^OBGO|M77?Sd", "^OBGO|M77?Sd", 8, "SM`]W(ioa$!|#>fUqc");
      // Undeclared exception!
      try { 
        uMCarroJa0.setBasePrice(owner0, (-2208), 0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test44()  throws Throwable  {
      UMCarroJa uMCarroJa0 = new UMCarroJa();
      Owner owner0 = new Owner("%x4mJj|r11XP!l", "%x4mJj|r11XP!l", "", (-536), "CPjI3+A[");
      uMCarroJa0.refuse(owner0, (Rental) null);
      assertEquals(100, owner0.getRates());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      Double double0 = new Double((-1.0));
      Point point0 = new Point(double0, double0);
      Client client0 = new Client(point0, "Todos", "", "", "%-OowcCt)J3Q", 0);
      CarModel.CarType carModel_CarType0 = CarModel.CarType.ELECTRIC;
      CarModel carModel0 = new CarModel(carModel_CarType0, 0.0, (String) null);
      Car car0 = new Car("", (Owner) null, carModel0, 0, 0.0, 3639, point0);
      Rental rental0 = new Rental(car0, client0, point0);
      // Undeclared exception!
      try { 
        uMCarroJa0.rate(client0, rental0, 0, 3639);
        fail("Expecting exception: NullPointerException");
  ...
  public void test50()  throws Throwable  {
      ...
      CarModel.CarType carModel_CarType0 = CarModel.CarType.ELECTRIC;
      try { 
        uMCarroJa0.rental("", point0, ":IBh|*zESs`y)om^3", carModel_CarType0);
        fail("Expecting exception: Exception");
