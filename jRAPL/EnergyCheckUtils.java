...
public class EnergyCheckUtils {
	...
	public static double[] getEnergyStats() {
		...
		System.out.println("EnergyInfo: "+EnergyInfo);
		/*One Socket*/
		if(socketNum == 1) {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < socketNum; i++) {
			...
			System.out.println("Power consumption of CPU: " + (after[1] - before[1]) / 10.0 );
			System.out.println("Power consumption of Package: " + (after[2] - before[2]) / 10.0);
		}
		ProfileDealloc();
	}
}
