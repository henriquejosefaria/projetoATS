...
public class Table_ESTest extends Table_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Table<String> table0 = new Table<String>(linkedList1, linkedList0, linkedList2);
      linkedList2.add(":%HUa<yXn.");
  ...
  public void test2()  throws Throwable  {
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.addLast("NA&Y'ya9b_uRsu(");
      LinkedList<String> linkedList1 = new LinkedList<String>();
      LinkedList<List<String>> linkedList2 = new LinkedList<List<String>>();
      Table<String> table0 = new Table<String>(linkedList2, linkedList0, linkedList1);
      String string0 = table0.toString();
      assertEquals("+-----------------+\n|                 |\n+-----------------+\n| NA&Y'ya9b_uRsu( |\n+-----------------+\n", string0);
  }
