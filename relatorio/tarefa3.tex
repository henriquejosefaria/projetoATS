...
\par Agora para correr os testes ao nosso programa basta-nos clicar no botão do canto superior direito assinalado na imagem para correr os testes com coverage.

\begin{figure}[H]

  \centering

  \includegraphics[scale = 0.45]{runCoverage.png}
