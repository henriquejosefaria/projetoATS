...
\begin{itemize}
\item Usar switch sem caso \textit{default:}. Bastou substituir o ultimo \textit{case "...":} por \textit{default:} para cumprir o mesmo objetivo do código anterior.
 Ficheiro: Controller.java, Car.java e Parser.java\newline
\end{itemize}

\begin{itemize}
\item Ter constantes num enum escritas em letras minusculas. Basta escreve-las em maiúsculas para as escrever segundo a convenção.
 Ficheiro: Car.java\newline
\end{itemize}
