...
public class Point_ESTest extends Point_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Double double1 = new Double((-1283.92880912603));
  ...
  public void test02()  throws Throwable  {
      Double double0 = new Double((-1961.0337));
      Point point0 = new Point(double0, double0);
  ...
  public void test04()  throws Throwable  {
      Double double0 = new Double((-542.675773140132));
      Point point0 = new Point(double0, double0);
      double double1 = point0.getY();
      assertEquals((-542.675773140132), double1, 0.01);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      Double double0 = new Double(1446.86);
      Point point0 = new Point(double0, double0);
      double double1 = point0.getX();
      assertEquals(1446.86, double1, 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      assertFalse(point1.equals((Object)point0));
      assertFalse(boolean0);
      assertEquals(1446.86, point1.getX(), 0.01);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertFalse(point1.equals((Object)point0));
      assertFalse(boolean0);
      assertEquals(1446.86, point1.getY(), 0.01);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Double double0 = new Double(508.36);
      Point point0 = new Point(double0, double0);
      Point point1 = point0.myclone();
      boolean boolean0 = point1.equals(point0);
      assertTrue(boolean0);
