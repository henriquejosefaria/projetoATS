...
public class SpecificCar_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "main.java.view.viewmodel.SpecificCar"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("main.java.utils.Point", false, SpecificCar_ESTest_scaffolding.class.getClassLoader()));
  }
