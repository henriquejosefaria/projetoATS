...
public class RegisterCar_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "main.java.view.viewmodel.RegisterCar"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("main.java.utils.Point", false, RegisterCar_ESTest_scaffolding.class.getClassLoader()));
  }
